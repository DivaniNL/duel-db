...
<body>
<img onclick="home()" class='titleimg' src="img/dueldb.png">
<br>
...
<form method="POST" action="" id="searchform"><div class="editdiv"><input  type="text" class="input textfield" placeholder="Search for a Figure name or a creator!" value = "<?php echo $q?>"><input type = "button"  class="submit2 button_s" value="Search!" ></div></form>
	<br>
<script>
var attacks = [
    [],
...
var damages = attacks[3];
        let Read_all = (inputval) => {
            fetch("api/product/search.php?q="+inputval)
